...
TOPIC_MESSAGE_SENT = "kv/message/sent"
TOPIC_CALL_INITIATED = "kv/call/initiated"
...
def get_publisher() -> mqtt.Client:
    ...
    if _client is not None and _client.is_connected():
        return _client
    _client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION2, client_id="messaging-service-pub")
